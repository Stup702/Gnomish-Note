...
A fast, mediumweight sticky note and desktop scratchpad built for GNOME on Linux (Wayland via XWayland and X11) that keeps notes always on top and out of the Alt-Tab switcher.
